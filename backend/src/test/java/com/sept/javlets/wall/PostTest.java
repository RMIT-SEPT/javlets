...
class PostTest {
    ...
    void testPost() {
        postRepository.save(new PostBean(
        		"Student", "A Tragedy", "Did you ever hear the story of Darth Plagueis the Wise?",
                                userRepository.findByUsername("Test User"), 123, "wallpost"));
    ...
    void testLivestreamPost() {
    	postRepository.save(new LivestreamPostBean(
    			"Mentor", "Monday Lecture", "Please watch this livestream at the date posted", userRepository.findByUsername("Test User"),
