...
class ScheduledLiveStream extends Component{
  ...
  refreshWall() {
      ...
      .then(result => {
          const allPosts = result.data.reverse().map(obj => ({type: obj.type, title: obj.title, body: obj.body, author: obj.author, id: obj.postId, category: obj.category, selectDate: obj.selectDate}));
